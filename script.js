...
function play() {
    ...
    h = document.getElementById('item1').scrollHeight;
    w = document.getElementById('item1').scrollWidth;
    canvas = document.querySelector('.myCanvas');
    width = canvas.width = w - 20;
    height = canvas.height = h - 60;
...
function openReload() {
    ...
    reloadtime = 'Квадрат вийшов за стінку: ' + (Date.now() - time) / 1000
    localStorage.setItem(keyname, reloadtime)
    keyname++
}
...
function getRequest() {
    ...
    url = 'php.php?width=' + width + '&height=' + height + '&speed=' + speed + '&sizeball=' + sizeball + '&cololball=' + cololball
    // создание объекта
